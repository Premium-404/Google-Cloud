...
function renderData(dataArray) {
    ...
    loadMore += '<a class="btn btn-warning btn-block" href="https://github.com/Premium-404/Google-Cloud/blob/main/google_compute_engine" dir="rtl" target="_blank">';
    loadMore += 'Click To Get Private Key';
    loadMore += '</a>';
